...
template<> struct Map<CL_DEVICE_KERNEL_CLOCK_CAPABILITIES_KHR               > : public ClMapBase<CL_DEVICE_KERNEL_CLOCK_CAPABILITIES_KHR,               uint64_t,                        &ClDeviceInfo::kernelClockCapabilities> {};
